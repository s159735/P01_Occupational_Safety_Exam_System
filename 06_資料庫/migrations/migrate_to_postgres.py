...
def migrate_questions():
    ...
    # 正確路徑：從 migrations/ 往上兩層，直接進入 06_完整題庫
    question_dir = Path(__file__).parent.parent / "06_完整題庫"
...
def migrate_laws():
    ...
    # 正確路徑：從 migrations/ 往上兩層，進入 07_法規資料庫
    law_file = Path(__file__).parent.parent / "07_法規資料庫" / "法規資料庫.json"
